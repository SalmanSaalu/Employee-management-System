...
//   }} type='password' /><br/>
//   postal code :<br/>
//   <input value={postalcode} onChange={(e)=>setPostalcode(e.target.value)} type='text'/><br/>
//   address:<br/>
//   <input value={address} onChange={(e)=>setAddress(e.target.value)} type='text'/><br/>
//   salary:<br/>
//   <input value={salary} readOnly type='text'/><br/>
//   position:<br/>
//   <input value={position} onChange={(e)=>setPosition(e.target.value)} type='text'/><br/>
//   phonenumber: <br/>
//   <input value={phonenumber} onChange={(e)=>setPhonenumber(e.target.value)} type='text'/><br/>
